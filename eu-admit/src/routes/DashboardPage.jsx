...
const DashboardPage = () => {
  const { applications, universities, toggleTask } = useAppContext();
          ...
          <div className="flex h-full w-full max-w-lg flex-col gap-6 rounded-l-3xl border border-slate-200 bg-white p-6 shadow-2xl">
            ...
            <div className="flex-1 space-y-5 overflow-y-auto pr-2">
              <div>
                ...
                <Checklist tasks={selectedApplication.tasks} onToggle={(taskId) => toggleTask(selectedApplication.id, taskId)} />
              </div>
